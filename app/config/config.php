...
$configuredAiKey = getenv('OPENROUTER_API_KEY') ?: (getenv('GROQ_API_KEY') ?: (getenv('AI_API_KEY') ?: ''));
define('GROQ_API_KEY', $configuredAiKey);
...
define('GROQ_DEFAULT_MODEL', getenv('AI_MODEL') ?: (getenv('GROQ_DEFAULT_MODEL') ?: (strpos($configuredAiKey, 'sk-or-v1-') === 0 ? 'openai/gpt-4o' : 'openai/gpt-oss-120b')));
define('GROQ_FAST_MODEL', getenv('AI_FAST_MODEL') ?: (getenv('GROQ_FAST_MODEL') ?: (strpos($configuredAiKey, 'sk-or-v1-') === 0 ? 'openai/gpt-4o-mini' : 'openai/gpt-oss-20b')));
